    ...
    <section id='contactus' className='mx-auto w-5/6 pt-24 pb-32'>
        <motion.div onViewportEnter={()=>setSelectedPage("contactus")}>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    <form target='_blank' onSubmit={handleSubmit} method='POST' action={"https://formsubmit.co/kianathekad@gmail.com"}>
                        ...
                        <button type='submit' className='mt-5 bg-secondary-500 rounded-lg px-20 py-3 transition duration-500 hover:text-white'>
                            SUBMIT
                        </button>
                    </form>
                </motion.div>
                ...
                >
                    <img
                      src={EvolveText}
                      alt="Evolve text"
                      className="hidden md:block md:absolute md:-bottom-18 md:-right-10 md:z-[-1] md:w-[720px] md:h-auto"
                    />
                    <div>
